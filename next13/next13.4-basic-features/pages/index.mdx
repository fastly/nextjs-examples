...
This site is built using [Next.js](https://github.com/vercel/next.js) 13.4.4 on [@fastly/next-compute-js v2](https://github.com/fastly/next-compute-js),
...
call [/api/revalidate/props-revalidate-false](/api/revalidate/props-revalidate-false).
